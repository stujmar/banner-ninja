  ...
  return (
    <div className={`w-full rounded-lg p-3 relative overflow-hidden border border-${theme}-300 shadow-md bg-white`}>
        <div className="flex justify-between items-end w-full">
          ...
          <div className={`bg-green-200 p-1 rounded-lg shadow  text-sm font-medium text-green-600 mr-2 transition-all ${isCopying ? "opacity-100" : "opacity-0"}`}>COPIED</div>
          <button onClick={()=>copyToClipboard()} className="text-gray-600 border border-slate-500 rounded p-px hover:bg-slate-100">
