        ...
        <div className="h-24 p-3 bg-white rounded-md border border-slate-300 shadow-md">
            ...
            <div className="flex gap-2 mt-4">
                <div className="flex items-center">
                    ...
                    <label htmlFor="default-radio-1" className="font-nunito font-bold ml-2 text-sm text-gray-900 dark:text-gray-300">Waves</label>
                </div>
                <div className="flex items-center">
                    <input disabled={true} checked={ mode == "bokeh" } id="default-radio-2" type="radio" onChange={(e) => handleChange(e)} value="bokeh" name="mode-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                    <label htmlFor="default-radio-2" className="font-nunito font-bold ml-2 text-sm text-gray-900 dark:text-gray-300">Bokeh</label>
                </div>
                <div className="flex items-center">
